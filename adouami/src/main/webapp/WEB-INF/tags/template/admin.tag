        ...
        <ul class="nav navbar-nav">
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
	            	              <li><a href="<c:url value='/teste/form'/>"><span class="glyphicon glyphicon-plus-sign"></span> Add teste</a></li>	              
	              <li><a href="<c:url value='/teste'/>"><span class="glyphicon glyphicon-menu-hamburger"></span> List teste</a></li>
